...
class HostageEmail(Base):
    __tablename__ = 'hostage_emails'
    ...
    hostage_sentences = Column(ARRAY(String))
    sentences = Column(ARRAY(String))
    user_id = Column(Integer, ForeignKey('users.id'))
    user = relationship('User', back_populates='hostage_emails')
    def to_dict(self):
        return {
            'id': self.id,
            ...
            'hostage_sentences': self.hostage_sentences
        }
